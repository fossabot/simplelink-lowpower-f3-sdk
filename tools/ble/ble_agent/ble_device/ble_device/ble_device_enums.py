...
class ConnectionCommands(enum.IntEnum):
    ...
    CONNECTION_CMD_PARAMETER_UPDATE = 0x04
    CONNECTION_CMD_CHANNEL_MAP_UPDATE = 0x05
    CONNECTION_CMD_SET_DATA_LENGTH = 0x06
...
class RREQCommands(enum.IntEnum):
    ...
    RREQ_CMD_ABORT = 0x04
    RREQ_CMD_CONFIGURE_CHAR = 0x05
    RREQ_CMD_CS_PROCEDURE_STARTED = 0x06
...
class RASCharsUUID(enum.IntEnum):
    ...
    RAS_ON_DEMAND_UUID = 0x2C16
    RAS_CONTROL_POINT_UUID = 0x2C17
    RAS_DATA_READY_UUID = 0x2C18
    RAS_DATA_OVERWRITTEN_UUID = 0x2C19
...
class ConnectionEventType(enum.IntEnum):
    ...
    NWP_LINK_PARAM_UPDATE_REJECT_EVENT = 0x00B4
...
class ConnectionEventNotifyType(enum.IntEnum):
    CONNECTION_CB_EVENT_INVALID = 0x00
    CONNECTION_CB_EVENT_ESTABLISHED = 0x01
    CONNECTION_CB_EVENT_PHY_UPDATE = 0x02
    CONNECTION_CB_EVENT_ALL = 0xFF
...
class HciBleEventType(enum.IntEnum):
    HCI_BLE_EVENT_PHY_UPDATE = 0x0C
    HCI_BLE_EVENT_PARAMETER_UPDATE_COMPLETE = 0x03
    HCI_BLE_EVENT_PARAMETER_UPDATE_REJECT = 0x83
    HCI_BLE_EVENT_CHANNEL_MAP_UPDATE = 0x82
    HCI_BLE_EVENT_DATA_LENGTH_UPDATE = 0x07