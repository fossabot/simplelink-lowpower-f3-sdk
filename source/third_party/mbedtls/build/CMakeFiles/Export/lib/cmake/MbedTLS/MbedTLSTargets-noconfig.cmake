...
# Import target "MbedTLS::ti_sl" for configuration ""
set_property(TARGET MbedTLS::ti_sl APPEND PROPERTY IMPORTED_CONFIGURATIONS NOCONFIG)
set_target_properties(MbedTLS::ti_sl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libti_sl.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS MbedTLS::ti_sl )
list(APPEND _IMPORT_CHECK_FILES_FOR_MbedTLS::ti_sl "${_IMPORT_PREFIX}/lib/libti_sl.a" )
